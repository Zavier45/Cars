...
export const addCustomOrder = async () => {
  ...
  await fetch(`https://localhost:7259/orders`, {
    method: "POST",
    headers: {
...
export const getOrders = async () => {
  const res = await fetch("https://localhost:7259/orders");
  const data = await res.json();
  return data;
};

export const getWheels = async () => {
  const res = await fetch("https://localhost:7259/wheels");
  const data = await res.json();
  return data;
};

export const getInteriors = async () => {
  const res = await fetch("https://localhost:7259/interiors");
  const data = await (await res).json();
  return data;
};

export const getTechnologies = async () => {
  const res = await fetch("https://localhost:7259/technologies");
  const data = await res.json();
  return data;
};

export const getPaints = async () => {
  const res = await fetch("https://localhost:7259/paintcolors");
  const data = await res.json();
  return data;
};
